...
use App\Http\Controllers\SuperAdmin\MedicalCertificateController;
...
Route::group(['middleware' => ['XssSanitizer']], function () {
    ...
    Route::middleware(['auth'])->group(function () {
        ...
        // User side certificate
        Route::get('/certificate', [CertificateController::class, 'index'])->name('certificate.index');
        Route::get('/certificate-generate', [CertificateController::class, 'generateCertificate'])->name('certificate.generate');
        Route::post('/store-certificate', [CertificateController::class, 'storeCertificate'])->name('store.certificate');
        // Update the route method to GET
        // Route to store the certificate (initial submission redirects to payment page)
        Route::post('/store-certificate', [CertificateController::class, 'storeCertificate'])->name('store.certificate');

        // Route to handle payment confirmation and final certificate storage
        Route::post('/confirm-payment', [CertificateController::class, 'confirmPayment'])->name('confirm.payment');

        Route::get('/download-certificate/{id}', [CertificateController::class, 'downloadCertificate'])->name('download-certificate');
    });
    ...
    Route::middleware(['auth'])->group(function () {
        ...
        // Medical Certificate Route
        Route::get('certificate_list', [MedicalCertificateController::class, 'index']);
        Route::post('certificate/{id}/send', [MedicalCertificateController::class, 'send'])->name('certificate.send');
        Route::post('certificate/{id}/delete', [MedicalCertificateController::class, 'delete'])->name('certificate.delete');
          Route::post('/certificate-price/update', [MedicalCertificateController::class, 'update'])->name('certificate.price.update');
