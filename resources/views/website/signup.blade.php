                ...
                <div class="{{ $active == 'doctor' ?  'active' : 'hide' }} doctorDiv">
                    <form action="{{ url('doctorRegister') }}" method="post">
                        ...
                        <div class="pt-3">
                            ...
                            <div class="relative mb-3" data-te-datepicker-init data-te-input-wrapper-init data-te-format="dd-mm-yyyy">
                                <input name="doc_dob" value="{{ old('doc_dob') }}" placeholder="dd-mm-yyyy" class="@error('doc_dob') is-invalid @enderror w-full text-sm font-fira-sans text-gray block p-2 z-20" data-te-datepicker-toggle-ref data-te-datepicker-toggle-button-ref />
                            </div>
                            @error('doc_dob')
                            <div class="invalid-feedback">
                                {{ $message }}
                ...
                <div class="{{ $active == 'patient' ?  'active' : 'hide' }} patientDiv">
                    <form action="{{ url('signUp') }}" method="post">
                        ...
                        <div class="pt-3">
                            ...
                            <div class="relative mb-3" data-te-datepicker-init data-te-input-wrapper-init data-te-format="dd-mm-yyyy">
                                <input name="dob" value="{{ old('dob') }}" placeholder="dd-mm-yyyy" class="@error('dob') is-invalid @enderror w-full text-sm font-fira-sans text-gray block p-2 z-20" data-te-datepicker-toggle-ref data-te-datepicker-toggle-button-ref />
                            </div>
                            @error('dob')
                            <div class="invalid-feedback">
                                {{ $message }}
